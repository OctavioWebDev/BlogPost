...
<Alert type="info">
  Want to learn more? Check out the official documentation for [React](https://reactjs.org/docs/getting-started.html) and [Tailwind CSS](https://tailwindcss.com/docs).
</Alert>
